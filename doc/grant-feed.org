...
```"id","category","type","url","institution-reference","title","funding-type","start-date","end-date","c-ucop-sponsor","funder-name","funder-reference","amount-value","amount-currency-code","visible"
