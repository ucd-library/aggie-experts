...
<div class="faq container top">
  <div class="section">
    ...
    <ucd-theme-list-accordion>
      ...
      <li>
        <p>The current version of Aggie Experts includes only senate faculty. We will be expanding it in stages to other researchers. If you are senate faculty, and you don't see your profile, please, <a href="mailto:lib-experts@ou.ad3.ucdavis.edu">contact us</a>.</p>
      </li>
      <li>How often do you update the data in Aggie Experts?</li>
      <li>
        <p>At this stage we will update the data weekly. As the project progresses, we will implement nightly updates. Grants data are updated quarterly.</p>
      </li>
      <li>What sources do you use for my publications?</li>
      <li>
        <p>We are using the Publication Management System adopted by the California Digital Library in support of the UC Open Access policy. The sources used are Dimensions, Scopus, Crossref, Web of Science (Lite), Europe PubMed Central, PubMed, eScholarship, arXiv, RePEc, SSRN, DBLP, CiNii EN, CiNii JP, figshare.com (limited) and Google Books. At this time only journal articles, books and book chapters, and conference papers are included in Aggie Experts.</p>
      </li>
      <li>What sources do you use for my grants? Why can't I edit the grant records?</li>
      <li>
        <p>We receive the data from the university's financial warehouse. They have been reconciled with UCOP records
        ...
        original source of a subaward.</p>
      </li>
    </ucd-theme-list-accordion>
    ...
    <ucd-theme-list-accordion>
      ...
      <li>
        <p>Most likely you have not claimed your publications in the Publication Management System we are using as a data source. Please, refer to "<a @click="${this._jumpTo}" data-jump-to="change-pub" href="#change-pub">How do I edit my publication record?</a>" to enrich your publication list.</p>
      </li>
      <li>Why are there incorrect publications on my profile? How do I remove them?</li>
      <li>
        <p>The process used to enrich profiles with publications relies on publication aggregations
        ...
        number of publications are incorrect, please, <a href="mailto:lib-experts@ou.ad3.ucdavis.edu">contact us</a>.</p>
      </li>
      ...
      <li>
        <p>Click on the edit icon above the list of your works. Once the "Manage My Works" page opens,
        ...
        <p>Aggie Experts uses the <a href="https://oapolicy.universityofcalifornia.edu/">UC Publication Management System</a> as it's official record of an expert's citation.
        When an experts makes an editorial change, like changing the visibility or rejecting a citation, this action is first performed on the data you see in Aggie Experts,
        and then propagated to the Publication Management System. If that system is not available, the process might fail, and you will see an error message.
        In this case, the expert's selection may be reverted when the next sync with this system takes place. You can make the desired changes directly in
        the <a href="https://oapolicy.universityofcalifornia.edu/">UC Publication Management System</a>, and these changes will be reflected on the next synchronization.</p>
      </li>

      <li id="reject-publication">How do I reject a publication?</li>
      <li>
        <p>Click on the edit icon above the list of your works. Once the "Manage My Works" page opens, click on the trash can icon by the publication that you want to disclaim.</p>
      ...
      <li>
        <p>Log into the UC Publication Management System account and go to "Edit My Profile".
        Under "Profile privacy", switch the settings from "Public" to "Internal". After the data are
        refreshed, Aggie Experts will not display any information about you, including your name.</p>
      </li>
    </ucd-theme-list-accordion>
  </div>
</div>
