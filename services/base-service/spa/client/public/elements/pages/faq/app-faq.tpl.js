...
<div class="faq container top">
  <div class="section">
    ...
    <ucd-theme-list-accordion>
      ...
      <li>How does search work on Aggie Experts?</li>
      <li>
        <p>
      ...
      <li>
        ...
        <div>
          <ul>
            <li>
              <p>
                To change your name, go to the <a href="https://ucpath.universityofcalifornia.edu/personal-information/personal-information-summary">Personal Information Summary in UCPath</a>
                and click on the drop-down menu in Legal Name / Name. Click on the tab with your name. Once directed to the new page, select Edit Legal Name/ Name. Scroll to the second half of
                the page to edit how your name appears. This is a separate set of fields from your legal name - <strong>do not edit your legal name</strong>.
                At the bottom of the page first click on Refresh Name to preview, and then on OK.
              </p>
            </li>
            <li>
              To change your title, update the <a href="https://org.ucdavis.edu/odr/">campus directory</a> listing. Once the changes are approved by directory administrators, they will
              be reflected in Aggie Experts at the next update. More information on the UC Davis Directory can be found <a href="https://org.ucdavis.edu/directory/index.html">here</a>. If you are
              not able to change the information already in the directory, you will need to contact HR.
            </li>
          </ul>
        </div>
      </li>
      <li id="add-more-info">How do I add more information to what you already have in Aggie Experts?</li>
      <li>
        <p>
