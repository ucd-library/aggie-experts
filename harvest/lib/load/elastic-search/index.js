 ...
 * @param {Date|Temporal.PlainDate|String} date Date object, Temporal.PlainDate, or string in the format "year-week" (e.g., "2023-37") to suffix the index name
 ...
 * @param {Date|Temporal.PlainDate|String} date - The date for which to get the index name. Can be a Date object, Temporal.PlainDate, or a string in the format "year-week" (e.g., "2023-37").
...
function getIndexNameForDate(index, date) {
  ...
  if( typeof date === 'string' ) {
    ...
    // Convert JS Date to Temporal.PlainDate using the configured timezone
    ...
    throw new Error('Date must be a string, Date object, or Temporal.PlainDate object');
  }
