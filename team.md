## Who is who
### Development team at UC Davis Library: 
Peter Brantley (Director of Online Strategy), Vessela Ensberg (Product Owner) Justin Merz (Senior Technology Architect), Dusty Cartwright (Application Programmer), Mike Grow (Data Solutions Engineer), Neil Weingarten (Project Manager), Kimmy Hescock (UX designer), Stephen Spelkey (Programmer), Sabrina Baggett (Programmer)

### Steering Advisors
Megan Van Noord (Librarian), Michael Ladisch (Scholarly Communications Officer, Library), Xiaoli Li (Content Services Head, Library), Whitney Cheung (Analyst, Office of Research)
